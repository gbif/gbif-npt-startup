(function($){
  Drupal.GM3.eol_gbif_maps_overlay = function(map){
    ...
    // Add a toggle button.
    $('#'+this.GM3.id).parent().append('<div class="gbif-toggle" style="position:relative; top:-40px;left:200px;height:0px;"><form><input id="gbif-toggle" type="checkbox" checked="checked"><label class="option" for="gbif-toggle">'+Drupal.t('GBIF data')+'</label></form></div>');
    var self = this;
